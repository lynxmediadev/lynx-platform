...
## 18) Home V2 experimental (`/` + `/about-us`)

Objetivo de esta sección:

- Registrar el cambio de home institucional a home de descubrimiento/catalogo.
- Mantener trazable que el home anterior no fue eliminado, sino movido a `/about-us`.
...
- Los tiles de assets deben ser clickeables y usar destinos temporales válidos mientras no exista catálogo real de merch/drops.
- Estética objetivo: brutalismo formal, catálogo de assets digitales, merchandising y servicios profesionales.
