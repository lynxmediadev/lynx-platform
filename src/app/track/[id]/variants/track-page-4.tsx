      ...
      <div className="mx-auto w-[90vw] max-w-[1700px] pb-20 pt-3 sm:pt-4">
        ...
        <section className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_330px] xl:items-start">
          <div className="space-y-3">
            <article className="rounded-md border border-border bg-card/35 p-3 sm:p-4">
              <div className="grid min-w-0 gap-3 sm:grid-cols-[168px_minmax(0,1fr)]">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
                    Track page 4 · ODR Records
                  </p>
                  <h1 className="mt-1 text-2xl font-semibold leading-tight sm:text-[30px]">
                    {track.title}
                  </h1>
                  <p className="text-sm text-muted-foreground sm:text-base">{track.artist || "Artista"}</p>

                  <div className="mt-2 flex flex-wrap gap-1.5">
                    <span className="rounded border border-border bg-background/80 px-2 py-0.5 text-xs font-semibold text-foreground">
            ...
            <article className="rounded-md border border-border bg-card/35 p-2.5">
              <PublicAudioBar
                src={audioSrc}
            ...
            <section className="grid gap-2 lg:grid-cols-[minmax(0,1fr)_320px]">
              <article className="rounded-md border border-border bg-card/35 p-3">
                ...
                <div className="mt-2 overflow-x-auto rounded border border-border">
                  <table className="min-w-full border-collapse text-sm">
                    <thead className="bg-background/70 text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
                      <tr>
                        <th className="border-b border-border px-2 py-1.5 text-left font-semibold">Licencia</th>
                        <th className="border-b border-border px-2 py-1.5 text-left font-semibold">Formatos</th>
                        <th className="border-b border-border px-2 py-1.5 text-right font-semibold">Precio</th>
                      </tr>
                    </thead>
                    <tbody>
                      {licenseOptions.map((option) => (
                        <tr key={option.id} className="odd:bg-card/25">
                          <td className="border-b border-border/70 px-2 py-1.5 font-semibold text-foreground">{option.title}</td>
                          <td className="border-b border-border/70 px-2 py-1.5 text-muted-foreground">{option.formats}</td>
                          <td className="border-b border-border/70 px-2 py-1.5 text-right font-semibold text-foreground">{option.price}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <p className="mt-1.5 text-xs text-muted-foreground">
                  Precios referenciales. Condiciones finales según uso y alcance.
                </p>
              </article>
              ...
              <article className="rounded-md border border-border bg-card/35 p-3">
                ...
                <dl className="mt-2 grid grid-cols-2 gap-x-2 gap-y-1.5 text-sm">
                  ...
                  <dd className="truncate text-right font-semibold text-foreground">{formatLicenseType(track.licenseType)}</dd>
                  ...
                  <dd className="text-right font-semibold text-foreground">{track.clearedForSync === false ? "Bajo revisión" : "Disponible"}</dd>
                  <dt className="text-muted-foreground">Actualizado</dt>
                  <dd className="text-right font-semibold text-foreground">{updatedLabel}</dd>
                </dl>
              </article>
            </section>

            <section id="entregables" className="rounded-md border border-border bg-card/35 p-3">
              <h2 className="text-[11px] font-semibold uppercase tracking-[0.14em] text-foreground/95">Entregables del track</h2>
