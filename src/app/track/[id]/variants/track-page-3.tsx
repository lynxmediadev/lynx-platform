        ...
        <section className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_330px] xl:items-start">
          <div className="space-y-3">
            <article className="rounded-md border border-border bg-card/35 p-3 sm:p-4">
              <div className="grid min-w-0 gap-3 sm:grid-cols-[132px_minmax(0,1fr)]">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
                    Track page 3 · ODR Records
                  </p>
                  <h1 className="mt-1 truncate text-2xl font-semibold leading-tight sm:text-[30px]">
                    {track.title}
                  </h1>
                  <p className="truncate text-sm text-muted-foreground sm:text-base">{track.artist || "Artista"}</p>
                  <div className="mt-2 grid grid-cols-2 gap-1.5 sm:grid-cols-4">
                    <div className="rounded border border-border bg-background/80 px-2 py-1 text-center">
                      <p className="text-[9px] uppercase tracking-[0.12em] text-muted-foreground">BPM</p>
                      <p className="text-sm font-semibold text-foreground">{track.bpm ? Math.round(track.bpm) : "—"}</p>
                    </div>
                    <div className="rounded border border-border bg-background/80 px-2 py-1 text-center">
                      <p className="text-[9px] uppercase tracking-[0.12em] text-muted-foreground">Key</p>
                      <p className="text-sm font-semibold text-foreground">{track.key || "—"}</p>
                    </div>
                    <div className="rounded border border-border bg-background/80 px-2 py-1 text-center">
                      <p className="text-[9px] uppercase tracking-[0.12em] text-muted-foreground">Duración</p>
                      <p className="text-sm font-semibold text-foreground">{formatDuration(track.durationSec)}</p>
                    </div>
                    <div className="rounded border border-border bg-background/80 px-2 py-1 text-center">
                      <p className="text-[9px] uppercase tracking-[0.12em] text-muted-foreground">Género</p>
                      <p className="truncate text-sm font-semibold text-foreground">{primaryGenre}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-2 grid gap-2 md:grid-cols-3">
                {licenseOptions.map((option) => (
                  <article key={option.id} className="rounded border border-border bg-background/75 p-2.5">
                    ...
                    <p className="mt-1 line-clamp-2 text-xs text-muted-foreground">{option.note}</p>
                  </article>
                ))}
              </div>
